    ...
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if(checkMemberExists())
            {
                ...
                Response.Write("<script>alert('Identifiant indisponible, veuillez réessayer);</script>");
            }
            else
            {
                signUpNewMember();
        ...
        void signUpNewMember()
        {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Write("<script>alert('Sign Up Réussite. Connectez-vous par Login');</script>");
